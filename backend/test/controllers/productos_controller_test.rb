...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { nombre: @producto.nombre, precio: @producto.precio } }, as: :json
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { nombre: @producto.nombre, precio: @producto.precio } }, as: :json
    assert_response :success
  end
